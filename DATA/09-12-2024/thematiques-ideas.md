...
#### Légendes et contes = comment chercher ?

_angano = contes_
_vezo = pecheur_

chaque ethnie = correspond a une region
tsimihety = nord de l'ile
Betsimisaraka = ethnie maman et grand parents -> cote est
sakalava = cote ouest
antanroy = sud
merina = centre / haut plateaux
betsileo = sud des hauts plateaux

#### Construction de la langue

Origines malaisiennes mais amalgame de langues --> peuples qui vienne en pirogues etc...
-> basé sur la sonorisation et après (voyelles non prononcées) question d'habitude
-> langues africaines
-> moura moura = calmement
-> rama = origine senegalaise?
-> culture asiatique & arabe

**Ma compréhension de la langue**
Sans savoir réellement parler le malgache, je reussi néanmoins a comprendre cette langue :
-> mix de plusieurs langues et mots français qui ressortent (traces de la colonisation française) : **contexte**
...
-> merna
-> langue réelement parlé non officielle

-> en fonction de quelle cote les autres sont arrivées
-> différents dialectes

-> langue officielle malgache
-> les gens qui dominent qui imposent leurs cultures / domination culturelle
-> merina qui domine les côtiers, viens de l'histoire : royauté / reine Ranavalona / jean laborde
